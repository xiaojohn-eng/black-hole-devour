...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ro(e,t,n){return new ta({name:`SphericalGaussianBlur`,defines:{SAMPLES:Co,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:Vo(),fragmentShader:`
	...
	`}var Ho=class extends Zt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Fi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;function kl(e,t,n){return Math.max(t,Math.min(n,e))}function Al(e,t){return e+Math.random()*(t-e)}function jl(e,t,n=new q){let r=Math.sqrt(Al(e*e,t*t)),i=Math.random()*Math.PI*2,a=Al(-r*.15,r*.15);return n.set(Math.cos(i)*r,a,Math.sin(i)*r),n}function Ml(e){return Math.max(.35,e**.4*.55)}function Nl(e){return Ml(e)*6.5}function Pl(e){return e>=1e6?(e/1e6).toFixed(2)+` M☉`:e>=1e3?(e/1e3).toFixed(2)+` k☉`:e.toFixed(1)+` ☉`}function Fl(e){return Math.floor(e).toLocaleString(`zh-CN`)}function Il(e){"@babel/helpers - typeof";return Il=typeof Symbol==`function`&&typeof Symbol.iterator==`symbol`?function(e){return typeof e}:function(e){return e&&typeof Symbol==`function`&&e.constructor===Symbol&&e!==Symbol.prototype?`symbol`:typeof e},Il(e)}function Ll(e,t){if(Il(e)!=`object`||!e)return e;var n=e[Symbol.toPrimitive];if(n!==void 0){var r=n.call(e,t||`default`);if(Il(r)!=`object`)return r;throw TypeError(`@@toPrimitive must return a primitive value.`)}return(t===`string`?String:Number)(e)}function Rl(e){var t=Ll(e,`string`);return Il(t)==`symbol`?t:t+``}function $(e,t,n){return(t=Rl(t))in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}var zl=class{constructor(e,t=!1){$(this,`group`,new kn),$(this,`mass`,void 0),$(this,`velocity`,new q),$(this,`isPlayer`,void 0),$(this,`alive`,!0),$(this,`horizon`,void 0),$(this,`disk`,void 0),$(this,`glow`,void 0),$(this,`ringLight`,void 0),$(this,`diskMat`,void 0),$(this,`targetScale`,1),$(this,`pulse`,0),this.mass=e,this.isPlayer=t;let n=this.radius,r=new Ki(1,48,48),i=new ci({color:0});this.horizon=new bi(r,i),this.horizon.scale.setScalar(n),this.group.add(this.horizon);let a=new bi(new Ki(1.08,48,32),new ci({color:t?16755302:11167487,transparent:!0,opacity:.35,side:1,blending:2,depthWrite:!1}));a.scale.setScalar(n),this.group.add(a),this.diskMat=new ta({vertexShader:Dl,fragmentShader:Ol,uniforms:{uTime:{value:0},uColorHot:{value:new X(t?16769184:13672703)},uColorCool:{value:new X(t?16736288:8405247)},uIntensity:{value:1.2}},transparent:!0,depthWrite:!1,side:2,blending:2});let o=new Gi(.35,1,64,4);this.disk=new bi(o,this.diskMat),this.disk.rotation.x=-Math.PI*.42,this.disk.scale.setScalar(n*2.8),this.group.add(this.disk);let s=new Vi(1.4,32),c=new ci({color:t?16746564:10053375,transparent:!0,opacity:.18,blending:2,depthWrite:!1,side:2});this.glow=new bi(s,c),this.glow.rotation.x=-Math.PI*.42,this.glow.scale.setScalar(n*2.8),this.group.add(this.glow),this.ringLight=new za(t?16750916:11167487,2.5,n*20),this.group.add(this.ringLight),this.targetScale=n}get radius(){return Ml(this.mass)}get attractRadius(){return Nl(this.mass)}get position(){return this.group.position}setMass(e){this.mass=e,this.targetScale=this.radius}addMass(e){this.mass+=e,this.targetScale=this.radius,this.pulse=1}update(e,t){this.diskMat.uniforms.uTime.value=t;let n=this.horizon.scale.x,r=jt.lerp(n,this.targetScale,1-.001**e);this.horizon.scale.setScalar(r),this.disk.scale.setScalar(r*2.8*(1+this.pulse*.15)),this.glow.scale.setScalar(r*2.8*(1+this.pulse*.2)),this.ringLight.distance=r*22,this.ringLight.intensity=2.2+this.pulse*3;let i=this.group.children[1];i&&i.scale.setScalar(r),this.disk.rotation.z+=e*.35,this.pulse=Math.max(0,this.pulse-e*2.5),this.isPlayer||(this.group.position.y=Math.sin(t*.7+this.mass)*.3)}dispose(){this.group.traverse(e=>{if(e instanceof bi){e.geometry.dispose();let t=e.material;Array.isArray(t)?t.forEach(e=>e.dispose()):t.dispose()}})}},Bl=[9075306,7037013,10128252,6050632],Vl=[16772795,16764040,11193599,16746598,16777215],Hl=[4491468,13395524,6728311,13412932,8939178];function Ul(e){let t=new Ui(e,1),n=t.attributes.position;for(let e=0;e<n.count;e++){let t=n.getX(e),r=n.getY(e),i=n.getZ(e),a=.75+Math.random()*.5;n.setXYZ(e,t*a,r*a,i*a)}return n.needsUpdate=!0,t.computeVertexNormals(),new bi(t,new ra({color:Bl[Math.random()*Bl.length|0],roughness:.92,metalness:.15,flatShading:!0}))}function Wl(e){let t=new kn,n=Vl[Math.random()*Vl.length|0],r=new bi(new Ki(e,24,24),new ci({color:n}));t.add(r);let i=new bi(new Ki(e*1.45,16,16),new ci({color:n,transparent:!0,opacity:.28,blending:2,depthWrite:!1}));t.add(i);let a=new za(n,1.2,e*25);return t.add(a),t}function Gl(e){let t=new kn,n=Hl[Math.random()*Hl.length|0],r=new Ki(e,32,32),i=new Float32Array(r.attributes.position.count*3),a=new X(n),o=new X(n).offsetHSL(.05,.1,.15);for(let t=0;t<r.attributes.position.count;t++){let n=r.attributes.position.getY(t)/e,s=.5+.5*Math.sin(n*8+Math.random()),c=a.clone().lerp(o,s);i[t*3]=c.r,i[t*3+1]=c.g,i[t*3+2]=c.b}r.setAttribute(`color`,new gr(i,3));let s=new ra({vertexColors:!0,roughness:.7,metalness:.1});if(t.add(new bi(r,s)),Math.random()>.55){let n=new bi(new Gi(e*1.4,e*2.1,48),new ci({color:13417386,transparent:!0,opacity:.45,side:2,depthWrite:!1}));n.rotation.x=Math.PI*.45,t.add(n)}return t}function Kl(e,t){switch(e){case`asteroid`:return Ul(t);case`star`:return Wl(t);case`planet`:return Gl(t);default:return Ul(t)}}function ql(e,t,n,r){let i=Al(n,r);switch(e){case`asteroid`:return Math.max(.5,t*i*.35);case`star`:return Math.max(2,t*i*.7);case`planet`:return Math.max(5,t*i*1.1);case`rival`:return Math.max(8,t*i*1.15);default:return t*.3}}function Jl(e,t){return e===`rival`?Math.max(.4,t**.4*.5):e===`star`?Math.max(.4,t**.33*.45):e===`planet`?Math.max(.5,t**.35*.5):Math.max(.25,t**.35*.35)}function Yl(e,t){return t*(e===`asteroid`?1:e===`star`?2.5:e===`planet`?5:12)}function Xl(e){e.traverse(e=>{if(e instanceof bi){e.geometry.dispose();let t=e.material;Array.isArray(t)?t.forEach(e=>e.dispose()):t.dispose()}})}var Zl=400,Ql=class{constructor(){$(this,`points`,void 0),$(this,`positions`,void 0),$(this,`colors`,void 0),$(this,`particles`,[]),$(this,`geo`,void 0),this.positions=new Float32Array(Zl*3),this.colors=new Float32Array(Zl*3),this.geo=new jr,this.geo.setAttribute(`position`,new gr(this.positions,3)),this.geo.setAttribute(`color`,new gr(this.colors,3));let e=new Oi({size:.35,vertexColors:!0,transparent:!0,opacity:.9,blending:2,depthWrite:!1,sizeAttenuation:!0});this.points=new Ni(this.geo,e),this.points.frustumCulled=!1;for(let e=0;e<Zl;e++)this.particles.push({life:0,maxLife:1,velocity:new q,active:!1}),this.positions[e*3+1]=-9999}emit(e,t,n,r=4,i=.6){let a=0;for(let o=0;o<Zl&&a<t;o++){let t=this.particles[o];if(t.active)continue;t.active=!0,t.life=i*(.6+Math.random()*.4),t.maxLife=t.life,t.velocity.set((Math.random()-.5)*r,(Math.random()-.5)*r,(Math.random()-.5)*r),this.positions[o*3]=e.x+(Math.random()-.5)*.5,this.positions[o*3+1]=e.y+(Math.random()-.5)*.5,this.positions[o*3+2]=e.z+(Math.random()-.5)*.5;let s=.7+Math.random()*.3;this.colors[o*3]=n.r*s,this.colors[o*3+1]=n.g*s,this.colors[o*3+2]=n.b*s,a++}this.geo.attributes.position.needsUpdate=!0,this.geo.attributes.color.needsUpdate=!0}emitSpiral(e,t,n,r){let i=0,a=new q().subVectors(t,e);for(let t=0;t<Zl&&i<n;t++){let n=this.particles[t];if(n.active)continue;n.active=!0,n.life=.4+Math.random()*.35,n.maxLife=n.life;let o=new q(-a.z,0,a.x).normalize().multiplyScalar((Math.random()-.5)*6);n.velocity.copy(a).normalize().multiplyScalar(8+Math.random()*6).add(o),this.positions[t*3]=e.x,this.positions[t*3+1]=e.y,this.positions[t*3+2]=e.z,this.colors[t*3]=r.r,this.colors[t*3+1]=r.g,this.colors[t*3+2]=r.b,i++}this.geo.attributes.position.needsUpdate=!0,this.geo.attributes.color.needsUpdate=!0}update(e){let t=!1;for(let n=0;n<Zl;n++){let r=this.particles[n];if(r.active){if(r.life-=e,r.life<=0){r.active=!1,this.positions[n*3+1]=-9999,t=!0;continue}this.positions[n*3]+=r.velocity.x*e,this.positions[n*3+1]+=r.velocity.y*e,this.positions[n*3+2]+=r.velocity.z*e,r.velocity.multiplyScalar(.96),t=!0}}t&&(this.geo.attributes.position.needsUpdate=!0)}dispose(){this.geo.dispose(),this.points.material.dispose()}},$l=`
...
`,tu=class{constructor(e=2500,t=400){$(this,`points`,void 0),$(this,`mat`,void 0);let n=new Float32Array(e*3),r=new Float32Array(e),i=new Float32Array(e);for(let a=0;a<e;a++){let e=Math.random(),o=Math.random(),s=2*Math.PI*e,c=Math.acos(2*o-1),l=t*(.55+Math.random()*.45);n[a*3]=l*Math.sin(c)*Math.cos(s),n[a*3+1]=l*Math.sin(c)*Math.sin(s),n[a*3+2]=l*Math.cos(c),r[a]=.6+Math.random()*2.2,i[a]=Math.random()}let a=new jr;a.setAttribute(`position`,new gr(n,3)),a.setAttribute(`aSize`,new gr(r,1)),a.setAttribute(`aPhase`,new gr(i,1)),this.mat=new ta({vertexShader:$l,fragmentShader:eu,uniforms:{uTime:{value:0}},transparent:!0,depthWrite:!1,blending:2}),this.points=new Ni(a,this.mat)}update(e,t){this.mat.uniforms.uTime.value=e,this.points.position.copy(t)}dispose(){this.points.geometry.dispose(),this.mat.dispose()}};function nu(e=8){let t=new kn,n=[2245802,6693512,2254421,8930338,3359846];for(let r=0;r<e;r++){let e=40+Math.random()*80,i=document.createElement(`canvas`);i.width=128,i.height=128;let a=i.getContext(`2d`),o=a.createRadialGradient(64,64,4,64,64,64),s=new X(n[r%n.length]);o.addColorStop(0,`rgba(${s.r*255|0},${s.g*255|0},${s.b*255|0},0.45)`),o.addColorStop(.4,`rgba(${s.r*255|0},${s.g*255|0},${s.b*255|0},0.12)`),o.addColorStop(1,`rgba(0,0,0,0)`),a.fillStyle=o,a.fillRect(0,0,128,128);let c=new ti(new Vr({map:new Ii(i),blending:2,depthWrite:!1,opacity:.55,transparent:!0}));c.scale.set(e,e,1);let l=Math.random()*Math.PI*2,u=60+Math.random()*180;c.position.set(Math.cos(l)*u,(Math.random()-.5)*40,Math.sin(l)*u),t.add(c)}return t}var ru=class{constructor(e,t){$(this,`keys`,new Set),$(this,`mouseDX`,0),$(this,`mouseDY`,0),$(this,`pointerLocked`,!1),$(this,`canvas`,void 0),$(this,`settings`,void 0),$(this,`wantPointerLock`,!1),$(this,`onKeyDown`,e=>{this.keys.add(e.code),e.code===`Escape`&&this.pointerLocked&&document.exitPointerLock()}),$(this,`onKeyUp`,e=>{this.keys.delete(e.code)}),$(this,`onMouseMove`,e=>{if(this.pointerLocked||e.buttons===1){let t=this.settings.sensitivity;this.mouseDX+=e.movementX*t*.002,this.mouseDY+=e.movementY*t*.002}}),$(this,`onClick`,()=>{this.wantPointerLock&&this.settings.pointerLock&&!this.pointerLocked&&this.canvas.requestPointerLock()}),$(this,`onPointerLockChange`,()=>{this.pointerLocked=document.pointerLockElement===this.canvas}),this.canvas=e,this.settings=t,window.addEventListener(`keydown`,this.onKeyDown),window.addEventListener(`keyup`,this.onKeyUp),document.addEventListener(`pointerlockchange`,this.onPointerLockChange),e.addEventListener(`mousemove`,this.onMouseMove),e.addEventListener(`click`,this.onClick)}updateSettings(e){this.settings=e}setPointerLockDesired(e){this.wantPointerLock=e,!e&&document.pointerLockElement===this.canvas&&document.exitPointerLock()}consumeMouseDelta(){let e=this.mouseDX,t=this.mouseDY;return this.mouseDX=0,this.mouseDY=0,{dx:e,dy:t}}getMoveVector(){let e=0,t=0;(this.keys.has(`KeyA`)||this.keys.has(`ArrowLeft`))&&--e,(this.keys.has(`KeyD`)||this.keys.has(`ArrowRight`))&&(e+=1),(this.keys.has(`KeyW`)||this.keys.has(`ArrowUp`))&&--t,(this.keys.has(`KeyS`)||this.keys.has(`ArrowDown`))&&(t+=1);let n=Math.hypot(e,t);return n>0&&(e/=n,t/=n),{x:e,z:t}}isPausePressed(){return this.keys.has(`KeyP`)||this.keys.has(`Escape`)}dispose(){window.removeEventListener(`keydown`,this.onKeyDown),window.removeEventListener(`keyup`,this.onKeyUp),document.removeEventListener(`pointerlockchange`,this.onPointerLockChange),this.canvas.removeEventListener(`mousemove`,this.onMouseMove),this.canvas.removeEventListener(`click`,this.onClick),document.pointerLockElement===this.canvas&&document.exitPointerLock()}},iu=class{constructor(e){$(this,`ctx`,null),$(this,`master`,null),$(this,`sfx`,null),$(this,`settings`,void 0),$(this,`ambienceNodes`,[]),$(this,`ambiencePlaying`,!1),this.settings=e}async ensure(){if(this.ctx){this.ctx.state===`suspended`&&await this.ctx.resume();return}this.ctx=new AudioContext,this.master=this.ctx.createGain(),this.sfx=this.ctx.createGain(),this.sfx.connect(this.master),this.master.connect(this.ctx.destination),this.applySettings(this.settings)}applySettings(e){this.settings=e,this.master&&this.sfx&&(this.master.gain.value=e.masterVolume,this.sfx.gain.value=e.sfxVolume)}now(){return this.ctx?.currentTime??0}playTone(e,t,n=`sine`,r=.15,i){if(!this.ctx||!this.sfx)return;let a=this.now(),o=this.ctx.createOscillator(),s=this.ctx.createGain();o.type=n,o.frequency.setValueAtTime(e,a),i!==void 0&&o.frequency.exponentialRampToValueAtTime(Math.max(20,i),a+t),s.gain.setValueAtTime(1e-4,a),s.gain.exponentialRampToValueAtTime(r,a+.02),s.gain.exponentialRampToValueAtTime(1e-4,a+t),o.connect(s),s.connect(this.sfx),o.start(a),o.stop(a+t+.05)}playNoise(e,t=.08,n=400){if(!this.ctx||!this.sfx)return;let r=this.now(),i=Math.floor(this.ctx.sampleRate*e),a=this.ctx.createBuffer(1,i,this.ctx.sampleRate),o=a.getChannelData(0);for(let e=0;e<i;e++)o[e]=Math.random()*2-1;let s=this.ctx.createBufferSource();s.buffer=a;let c=this.ctx.createBiquadFilter();c.type=`bandpass`,c.frequency.value=n,c.Q.value=.8;let l=this.ctx.createGain();l.gain.setValueAtTime(t,r),l.gain.exponentialRampToValueAtTime(1e-4,r+e),s.connect(c),c.connect(l),l.connect(this.sfx),s.start(r),s.stop(r+e)}playDevour(e){e===`small`?(this.playTone(220,.18,`triangle`,.1,80),this.playNoise(.12,.04,600)):e===`medium`?(this.playTone(160,.35,`sawtooth`,.12,50),this.playTone(90,.4,`sine`,.1,40),this.playNoise(.25,.08,300)):(this.playTone(80,.7,`sawtooth`,.18,30),this.playTone(55,.9,`sine`,.14,25),this.playNoise(.5,.14,180))}playAttractPulse(){this.playTone(90+Math.random()*40,.08,`sine`,.03)}playUIClick(){this.playTone(660,.06,`square`,.05),this.playTone(880,.08,`square`,.03)}playWin(){[523,659,784,1046].forEach((e,t)=>{setTimeout(()=>this.playTone(e,.35,`triangle`,.1),t*120)})}playLose(){this.playTone(200,.6,`sawtooth`,.12,40),this.playTone(150,.8,`sine`,.1,30),this.playNoise(.7,.1,120)}playLevelUp(){[440,554,659,880].forEach((e,t)=>{setTimeout(()=>this.playTone(e,.2,`triangle`,.09),t*90)})}startAmbience(){if(!this.ctx||!this.sfx||this.ambiencePlaying)return;this.ambiencePlaying=!0;let e=this.now(),t=this.ctx.createOscillator(),n=this.ctx.createGain();t.type=`sine`,t.frequency.value=42,n.gain.value=.025,t.connect(n),n.connect(this.sfx),t.start(e),this.ambienceNodes.push(t,n);let r=this.ctx.sampleRate*2,i=this.ctx.createBuffer(1,r,this.ctx.sampleRate),a=i.getChannelData(0);for(let e=0;e<r;e++)a[e]=(Math.random()*2-1)*.3;let o=this.ctx.createBufferSource();o.buffer=i,o.loop=!0;let s=this.ctx.createBiquadFilter();s.type=`lowpass`,s.frequency.value=200;let c=this.ctx.createGain();c.gain.value=.02,o.connect(s),s.connect(c),c.connect(this.sfx),o.start(e),this.ambienceNodes.push(o,s,c)}stopAmbience(){for(let e of this.ambienceNodes)try{`stop`in e&&typeof e.stop==`function`&&e.stop(),e.disconnect()}catch{}this.ambienceNodes=[],this.ambiencePlaying=!1}},au=`bhd_high_score`,ou=`bhd_settings`,su={masterVolume:.7,sfxVolume:.8,sensitivity:1,pointerLock:!1};function cu(){try{let e=localStorage.getItem(au);return e?Math.max(0,Number(e)||0):0}catch{return 0}}function lu(e){try{e>cu()&&localStorage.setItem(au,String(Math.floor(e)))}catch{}}function uu(){try{let e=localStorage.getItem(ou);if(!e)return{...su};let t=JSON.parse(e);return{...su,...t}}catch{return{...su}}}function du(e){try{localStorage.setItem(ou,JSON.stringify(e))}catch{}}var fu=class{constructor(e,t){$(this,`root`,void 0),$(this,`screens`,{}),$(this,`cbs`,void 0),$(this,`settings`,{...su}),$(this,`bannerEl`,null),this.cbs=t,this.root=document.createElement(`div`),this.root.id=`ui-root`,e.appendChild(this.root),this.build()}build(){this.root.innerHTML=`
    ...
    `,this.root.querySelectorAll(`.screen`).forEach(e=>{let t=e.dataset.screen;this.screens[t]=e}),this.root.addEventListener(`click`,e=>{let t=e.target.closest(`[data-action]`);if(t)switch(t.dataset.action){case`start`:this.cbs.onStart();break;case`howto`:this.cbs.onHowTo();break;case`settings`:this.cbs.onSettings();break;case`settings-pause`:this.showScreen(`settings`);break;case`back`:this.cbs.onBackTitle();break;case`pause`:window.dispatchEvent(new KeyboardEvent(`keydown`,{code:`KeyP`})),setTimeout(()=>window.dispatchEvent(new KeyboardEvent(`keyup`,{code:`KeyP`})),50);break;case`resume`:this.cbs.onResume();break;case`restart`:this.cbs.onRestart();break;case`title`:this.cbs.onTitle();break;case`next`:this.cbs.onNextLevel()}});let e=(e,t,n=!1)=>{let r=this.root.querySelector(`#`+e);r.addEventListener(`input`,()=>{n?this.settings[t]=r.checked:this.settings[t]=parseFloat(r.value),this.cbs.onSettingsChange({...this.settings})})};e(`set-master`,`masterVolume`),e(`set-sfx`,`sfxVolume`),e(`set-sens`,`sensitivity`),e(`set-plock`,`pointerLock`,!0),this.bannerEl=this.root.querySelector(`#level-banner`)}showScreen(e){let t={title:`title`,howto:`howto`,settings:`settings`,hud:`hud`,pause:`pause`,levelclear:`levelclear`,end:`end`,victory:`end`,defeat:`end`}[e]??e;for(let[e,n]of Object.entries(this.screens))n.classList.toggle(`hidden`,e!==t)}setSettings(e){this.settings={...e},this.root.querySelector(`#set-master`).value=String(e.masterVolume),this.root.querySelector(`#set-sfx`).value=String(e.sfxVolume),this.root.querySelector(`#set-sens`).value=String(e.sensitivity),this.root.querySelector(`#set-plock`).checked=e.pointerLock}updateHighScore(e){let t=this.root.querySelector(`#hs-value`);t&&(t.textContent=Math.floor(e).toLocaleString(`zh-CN`))}updateHud(e){let t=(e,t)=>{let n=this.root.querySelector(e);n&&(n.textContent=t)};t(`#hud-mass`,e.mass),t(`#hud-score`,e.score),t(`#hud-level`,e.level),t(`#hud-levelname`,e.levelName),t(`#hud-target`,e.target);let n=this.root.querySelector(`#hud-progress`);n&&(n.style.width=`${(e.progress*100).toFixed(1)}%`)}showLevelBanner(e,t){this.bannerEl&&(this.bannerEl.textContent=`第 ${t} 关 · ${e}`,this.bannerEl.classList.remove(`hidden`),this.bannerEl.classList.add(`show`),setTimeout(()=>{this.bannerEl?.classList.remove(`show`),this.bannerEl?.classList.add(`hidden`)},2200))}showLevelClear(e,t,n){this.showScreen(`levelclear`);let r=this.root.querySelector(`#lc-text`);r&&(r.textContent=`「${e}」完成！下一关：${t}`);let i=this.root.querySelector(`#lc-score`);i&&(i.textContent=n)}showEnd(e,t,n,r){this.showScreen(`end`);let i=this.root.querySelector(`#end-title`),a=this.root.querySelector(`#end-msg`);i&&(i.textContent=e?`宇宙主宰！`:`被更大的黑洞吞噬…`),a&&(a.textContent=e?`你已成为超级黑洞，通关全部关卡。`:`质量不及对手，事件视界将你吞没。`);let o=(e,t)=>{let n=this.root.querySelector(e);n&&(n.textContent=t)};o(`#end-score`,t),o(`#end-hs`,n),o(`#end-mass`,r)}},pu=[{id:1,name:`星际尘埃带`,startMass:10,targetMass:80,worldRadius:90,maxBodies:55,spawnWeights:{asteroid:.7,star:.22,planet:.08,rival:0},massScale:{min:.15,max:1.8},rivalCount:0,spawnRate:2.2},{id:2,name:`恒星摇篮`,startMass:80,targetMass:320,worldRadius:120,maxBodies:70,spawnWeights:{asteroid:.45,star:.35,planet:.15,rival:.05},massScale:{min:.2,max:2.4},rivalCount:2,spawnRate:2.8},{id:3,name:`星系核心`,startMass:320,targetMass:1200,worldRadius:150,maxBodies:85,spawnWeights:{asteroid:.3,star:.35,planet:.2,rival:.15},massScale:{min:.25,max:3.2},rivalCount:4,spawnRate:3.4}];function mu(e){return pu[Math.max(0,Math.min(pu.length-1,e-1))]}var hu=class{constructor(e){$(this,`renderer`,void 0),$(this,`scene`,new Ln),$(this,`camera`,void 0),$(this,`clock`,new oo),$(this,`input`,void 0),$(this,`audio`,void 0),$(this,`ui`,void 0),$(this,`settings`,void 0),$(this,`player`,void 0),$(this,`bodies`,[]),$(this,`particles`,void 0),$(this,`starfield`,void 0),$(this,`nebulae`,void 0),$(this,`phase`,`title`),$(this,`levelId`,1),$(this,`level`,void 0),$(this,`score`,0),$(this,`highScore`,0),$(this,`spawnAcc`,0),$(this,`time`,0),$(this,`shake`,0),$(this,`fovPunch`,0),$(this,`baseFov`,55),$(this,`yaw`,0),$(this,`attractPulseT`,0),$(this,`pauseLatch`,!1),$(this,`animId`,0),$(this,`running`,!1),$(this,`tmpV`,new q),$(this,`tmpV2`,new q),$(this,`loop`,()=>{if(!this.running)return;this.animId=requestAnimationFrame(this.loop);let e=Math.min(this.clock.getDelta(),.05);this.time+=e;let t=this.input.isPausePressed();t&&!this.pauseLatch&&(this.pauseLatch=!0,this.phase===`playing`?this.pause():this.phase===`paused`&&this.resume()),t||(this.pauseLatch=!1),this.phase===`playing`?this.updatePlaying(e):this.phase===`title`&&(this.camera.position.set(Math.sin(this.time*.15)*30,25,45+Math.cos(this.time*.1)*5),this.camera.lookAt(0,0,0)),this.starfield.update(this.time,this.player?.position??new q),this.particles.update(e),this.renderer.render(this.scene,this.camera)}),$(this,`onResize`,()=>{this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.renderer.setSize(window.innerWidth,window.innerHeight)}),this.settings=uu(),this.highScore=cu(),this.renderer=new El({antialias:!0,powerPreference:`high-performance`}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setClearColor(197900),this.renderer.outputColorSpace=We,e.appendChild(this.renderer.domElement),this.camera=new La(this.baseFov,window.innerWidth/window.innerHeight,.1,800),this.camera.position.set(0,28,42),this.input=new ru(this.renderer.domElement,this.settings),this.audio=new iu(this.settings),this.ui=new fu(e,{onStart:()=>void this.startGame(),onResume:()=>this.resume(),onRestart:()=>void this.startGame(1),onTitle:()=>this.toTitle(),onSettingsChange:e=>this.applySettings(e),onHowTo:()=>this.ui.showScreen(`howto`),onSettings:()=>this.ui.showScreen(`settings`),onBackTitle:()=>{this.phase===`paused`?this.ui.showScreen(`pause`):this.ui.showScreen(`title`)},onNextLevel:()=>void this.nextLevel()}),this.ui.updateHighScore(this.highScore),this.ui.setSettings(this.settings),this.buildWorldDecor(),this.ui.showScreen(`title`),window.addEventListener(`resize`,this.onResize),this.running=!0,this.loop()}buildWorldDecor(){this.starfield=new tu(2800,450),this.scene.add(this.starfield.points),this.nebulae=nu(10),this.scene.add(this.nebulae);let e=new Ua(3359846,.55);this.scene.add(e);let t=new Ha(8952251,.4);t.position.set(20,40,10),this.scene.add(t),this.particles=new Ql,this.scene.add(this.particles.points)}applySettings(e){this.settings=e,du(e),this.audio.applySettings(e),this.input.updateSettings(e),this.input.setPointerLockDesired(e.pointerLock&&this.phase===`playing`)}async startGame(e=1){await this.audio.ensure(),this.audio.playUIClick(),this.audio.startAmbience(),this.clearBodies(),this.player&&(this.scene.remove(this.player.group),this.player.dispose()),this.levelId=e,this.level=mu(this.levelId),this.score=e===1?0:this.score,this.shake=0,this.fovPunch=0,this.yaw=0,this.spawnAcc=0,this.pauseLatch=!1,this.player=new zl(this.level.startMass,!0),this.player.position.set(0,0,0),this.scene.add(this.player.group);let t=Math.min(this.level.maxBodies,28+this.levelId*8);for(let e=0;e<t;e++)this.spawnBody();for(let e=0;e<this.level.rivalCount;e++)this.spawnRival();this.phase=`playing`,this.input.setPointerLockDesired(this.settings.pointerLock),this.ui.showScreen(`hud`),this.ui.showLevelBanner(this.level.name,this.levelId),this.updateHud()}async nextLevel(){if(this.levelId>=pu.length){this.phase=`victory`,this.finishRun(!0);return}await this.startGame(this.levelId+1)}toTitle(){this.phase=`title`,this.input.setPointerLockDesired(!1),this.audio.stopAmbience(),this.clearBodies(),this.player&&(this.scene.remove(this.player.group),this.player.dispose(),this.player=void 0),this.ui.showScreen(`title`),this.ui.updateHighScore(cu())}resume(){this.phase===`paused`&&(this.phase=`playing`,this.input.setPointerLockDesired(this.settings.pointerLock),this.ui.showScreen(`hud`),this.audio.playUIClick())}pause(){this.phase===`playing`&&(this.phase=`paused`,this.input.setPointerLockDesired(!1),this.ui.showScreen(`pause`),this.audio.playUIClick())}pickType(){let e=this.level.spawnWeights,t=e.asteroid+e.star+e.planet+e.rival,n=Math.random()*t;return(n-=e.asteroid)<0?`asteroid`:(n-=e.star)<0?`star`:(n-=e.planet)<0?`planet`:`rival`}spawnBody(e){if(this.bodies.length>=this.level.maxBodies)return;let t=e??this.pickType();if(t===`rival`){this.spawnRival();return}let n=ql(t,this.player.mass,this.level.massScale.min,this.level.massScale.max),r=Math.min(n,this.player.mass*(t===`planet`?2.5:1.6)),i=Jl(t,r),a=Kl(t,i);jl(this.level.worldRadius*.35,this.level.worldRadius*.95,a.position),a.position.add(this.player.position);let o={type:t,mass:r,radius:i,alive:!0,beingPulled:!1,swallowProgress:0,velocity:new q((Math.random()-.5)*1.5,(Math.random()-.5)*.4,(Math.random()-.5)*1.5),mesh:a,rivalBH:null};this.scene.add(a),this.bodies.push(o)}spawnRival(){if(this.bodies.filter(e=>e.type===`rival`&&e.alive).length>=this.level.rivalCount+1)return;let e=ql(`rival`,this.player.mass,.7,this.level.massScale.max*.9),t=Math.random()>.55?e*1.15:e*.85,n=new zl(t,!1);jl(this.level.worldRadius*.45,this.level.worldRadius*.9,n.position),n.position.add(this.player.position),this.scene.add(n.group);let r={type:`rival`,mass:t,radius:n.radius,alive:!0,beingPulled:!1,swallowProgress:0,velocity:new q,mesh:n.group,rivalBH:n};this.bodies.push(r)}clearBodies(){for(let e of this.bodies)this.scene.remove(e.mesh),e.rivalBH?e.rivalBH.dispose():Xl(e.mesh);this.bodies=[]}updateHud(){this.player&&this.ui.updateHud({mass:Pl(this.player.mass),score:Fl(this.score),level:`${this.levelId} / ${pu.length}`,levelName:this.level.name,progress:kl(this.player.mass/this.level.targetMass,0,1),target:Pl(this.level.targetMass)})}finishRun(e){this.input.setPointerLockDesired(!1),lu(this.score),this.highScore=cu(),e?(this.audio.playWin(),this.phase=`victory`,this.ui.showEnd(!0,Fl(this.score),Fl(this.highScore),Pl(this.player.mass))):(this.audio.playLose(),this.phase=`defeat`,this.ui.showEnd(!1,Fl(this.score),Fl(this.highScore),Pl(this.player.mass)))}onLevelClear(){if(this.audio.playLevelUp(),this.levelId>=pu.length){this.finishRun(!0);return}this.phase=`levelclear`,this.input.setPointerLockDesired(!1);let e=mu(this.levelId+1);this.ui.showLevelClear(this.level.name,e.name,Fl(this.score))}updatePlaying(e){let t=this.input.getMoveVector(),{dx:n}=this.input.consumeMouseDelta();this.yaw-=n;let r=14+this.player.mass**.25*1.2,i=Math.cos(this.yaw),a=Math.sin(this.yaw),o=t.x*i-t.z*a,s=t.x*a+t.z*i;this.player.velocity.x=jt.lerp(this.player.velocity.x,o*r,1-.02**e),this.player.velocity.z=jt.lerp(this.player.velocity.z,s*r,1-.02**e),this.player.velocity.y=jt.lerp(this.player.velocity.y,0,.1),this.player.position.addScaledVector(this.player.velocity,e);let c=this.level.worldRadius;for(this.player.position.x=kl(this.player.position.x,-c,c),this.player.position.z=kl(this.player.position.z,-c,c),this.player.update(e,this.time),this.spawnAcc+=e*this.level.spawnRate;this.spawnAcc>=1;)--this.spawnAcc,this.spawnBody();this.attractPulseT-=e;let l=this.player.position,u=this.player.mass,d=this.player.radius,f=this.player.attractRadius;for(let t=this.bodies.length-1;t>=0;t--){let n=this.bodies[t];if(!n.alive){this.removeBodyAt(t);continue}n.type===`rival`&&n.rivalBH&&this.updateRival(n,e);let r=n.mesh.position,i=r.distanceTo(l);if(n.mass<u&&i<f){n.beingPulled=!0;let t=(1-i/f)*(8+u*.04);this.tmpV.subVectors(l,r).normalize().multiplyScalar(t*e),n.velocity.add(this.tmpV),this.tmpV2.set(-(r.z-l.z),0,r.x-l.x).normalize().multiplyScalar(t*.35*e),n.velocity.add(this.tmpV2),this.attractPulseT<=0&&Math.random()>.92&&(this.attractPulseT=.15,this.audio.playAttractPulse(),this.particles.emitSpiral(r,l,2,new X(16755302)))}else n.beingPulled=!1;if(n.mass<u&&i<d*1.15+n.radius*.3){this.swallow(n,`player`);continue}if(n.type===`rival`&&n.rivalBH&&n.mass>u){let t=i;if(t<n.rivalBH.radius*1.2+d*.3){this.finishRun(!1);return}if(t<n.rivalBH.attractRadius){let i=(1-t/n.rivalBH.attractRadius)*4*e;this.tmpV.subVectors(r,l).normalize().multiplyScalar(i),this.player.velocity.add(this.tmpV)}}n.mesh.position.addScaledVector(n.velocity,e),n.velocity.multiplyScalar(.992),n.type!==`rival`&&(n.mesh.rotation.x+=e*.4,n.mesh.rotation.y+=e*.6),i>this.level.worldRadius*1.6&&(n.alive=!1)}if(this.updateCamera(e),this.player.mass>=this.level.targetMass){this.onLevelClear();return}this.updateHud()}updateRival(e,t){let n=e.rivalBH;n.update(t,this.time),e.radius=n.radius,e.mass=n.mass;let r=null,i=1/0;for(let t of this.bodies){if(t===e||!t.alive||t.mass>=e.mass)continue;let a=t.mesh.position.distanceTo(n.position);a<i&&a<50&&(i=a,r=t)}r?(this.tmpV.subVectors(r.mesh.position,n.position).normalize(),n.velocity.lerp(this.tmpV.multiplyScalar(6+e.mass**.2),.02)):(this.tmpV.subVectors(this.player.position,n.position).normalize(),n.velocity.lerp(this.tmpV.multiplyScalar(3.5),.01)),n.position.addScaledVector(n.velocity,t);for(let r of this.bodies){if(r===e||!r.alive||r.mass>=e.mass)continue;let i=r.mesh.position.distanceTo(n.position);i<n.attractRadius&&(this.tmpV.subVectors(n.position,r.mesh.position).normalize().multiplyScalar((1-i/n.attractRadius)*6*t),r.velocity.add(this.tmpV)),i<n.radius*1.1+r.radius*.3&&(n.addMass(r.mass*.85),e.mass=n.mass,r.alive=!1,this.particles.emit(r.mesh.position,12,new X(11167487),5,.5))}}swallow(e,t){e.alive=!1;let n=e.mass*.9;this.player.addMass(n);let r=Yl(e.type,e.mass);this.score+=r;let i=e.mass>this.player.mass*.4?`large`:e.mass>this.player.mass*.15?`medium`:`small`;this.audio.playDevour(i),this.particles.emit(e.mesh.position.clone(),i===`large`?40:i===`medium`?22:10,new X(16764040),8,.7),this.particles.emitSpiral(e.mesh.position,this.player.position,15,new X(16737826)),i===`large`?(this.shake=.55,this.fovPunch=8):i===`medium`&&(this.shake=.25,this.fovPunch=4)}removeBodyAt(e){let t=this.bodies[e];this.scene.remove(t.mesh),t.rivalBH?t.rivalBH.dispose():Xl(t.mesh),this.bodies.splice(e,1)}updateCamera(e){let t=this.player.radius,n=22+t*4.5,r=14+t*2.2,i=Math.cos(this.yaw),a=Math.sin(this.yaw),o=this.tmpV.set(this.player.position.x+a*n,this.player.position.y+r,this.player.position.z+i*n);this.camera.position.lerp(o,1-.08**e),this.shake>0&&(this.camera.position.x+=(Math.random()-.5)*this.shake*2,this.camera.position.y+=(Math.random()-.5)*this.shake*2,this.shake=Math.max(0,this.shake-e*1.5)),this.tmpV2.copy(this.player.position),this.camera.lookAt(this.tmpV2),this.fovPunch>0?(this.camera.fov=this.baseFov+this.fovPunch,this.fovPunch=Math.max(0,this.fovPunch-e*18)):this.camera.fov=jt.lerp(this.camera.fov,this.baseFov,.1),this.camera.updateProjectionMatrix()}dispose(){this.running=!1,cancelAnimationFrame(this.animId),window.removeEventListener(`resize`,this.onResize),this.input.dispose(),this.audio.stopAmbience(),this.clearBodies(),this.starfield.dispose(),this.particles.dispose(),this.renderer.dispose()}},gu=document.querySelector(`#app`);if(!gu)throw Error(`#app not found`);new hu(gu);
//# sourceMappingURL=index-KohXKkLL.js.map